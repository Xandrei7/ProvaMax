...
export const Icons = {
  ...
  arrowDown: ({ className = "w-5 h-5" }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
  ...
  layers: ({ className = "w-6 h-6" }: IconProps) => (
  ...
  sparkle: ({ className = "w-6 h-6" }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className={className}>
